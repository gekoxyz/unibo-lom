...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\linewidth]{./images/interfaccia.jpeg}
  \caption{Interfaccia utente}
  \label{fig:interfaccia_utente}
\end{figure}
...
Nel software viene usata una \verb|struct Coin| per gestire i dati. La struttura è formata in questo modo:
